...
mod tests {
    use super::super::*;
    use super::super::definition::{AgentDefinition, AgentSource};
    ...
    fn test_explore_agent_disallowed_tools() {
        use super::super::builtins::explore::ExploreAgent;
    ...
    fn test_plan_agent_disallowed_tools() {
        use super::super::builtins::plan::PlanAgent;
    ...
    fn test_general_purpose_agent_allows_most_tools() {
        use super::super::builtins::general::{GeneralPurposeAgent, get_disallowed_tools};
    ...
    fn test_verification_agent_background() {
        use super::super::builtins::verification::VerificationAgent;
    ...
    fn test_agent_source() {
        use super::super::builtins::explore::ExploreAgent;
        use super::super::builtins::plan::PlanAgent;
        use super::super::builtins::general::GeneralPurposeAgent;
    ...
    fn test_resolve_agent_model() {
        use super::super::builtins::resolve_agent_model;
        ...
        // 具体模型名称
        assert_eq!(resolve_agent_model(Some("haiku"), parent), "claude-haiku-4-5-20251001");
        assert_eq!(resolve_agent_model(Some("sonnet"), parent), "claude-sonnet-4-6");
        assert_eq!(resolve_agent_model(Some("opus"), parent), "claude-opus-4-6");
        
        // 自定义模型 ID
        assert_eq!(resolve_agent_model(Some("custom-model"), parent), "custom-model");
    }

    #[test]
    fn test_get_agent_tool_set() {
        use super::super::builtins::get_agent_tool_set;
        ...
        // 同时使用白名单和黑名单
        let allowed = Some(&["file_read".to_string(), "file_write".to_string(), "bash".to_string()][..]);
