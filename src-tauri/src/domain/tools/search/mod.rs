...
impl super::ToolImpl for SearchTool {
    ...
    async fn execute(
        ...
        match category.as_str() {
            "web" => {
                let value = web::search_web_json(ctx, &args, &source, max_n, start).await?;
