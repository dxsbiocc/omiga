...
- `category="dataset"` (`data` alias) supports built-in dataset sources: `geo`, `ena`, `ena_run`, `ena_experiment`, `ena_sample`, `ena_analysis`, `ena_assembly`, `ena_sequence`, `cbioportal`, `gtex`, `ncbi_datasets`, `biosample`.
    ...
    ToolSchema::new(
        ...
        serde_json::json!({
            ...
            "properties": {
                ...
                "source": {
                    "type": "string",
                    "description": "Database source. Dataset supports auto, geo, ena, ena_run, ena_experiment, ena_sample, ena_analysis, ena_assembly, ena_sequence, cbioportal, gtex, ncbi_datasets, biosample. Knowledge supports ncbi_gene and uniprot."
                },
                "operation": {
                    "type": "string",
