...
pub(crate) use manifest::{
    discover_manifest_paths, load_operator_manifest, normalize_optional_string,
    validate_operator_id, OperatorCandidateSummary, OperatorExecutionSpec, OperatorFieldKind,
    OperatorFieldSpec, OperatorInterfaceSpec, OperatorManifestDiagnostic, OperatorMetadata,
    OperatorOperationGroupSummary, OperatorOperationSpec, OperatorOperationSummary,
    OperatorPreflightAskWhen, OperatorPreflightOptionSpec, OperatorPreflightQuestionSpec,
    OperatorPreflightSpec, OperatorRegistryEntry, OperatorRegistryFile, OperatorRegistryUpdate,
    OperatorResourceSpec, OperatorSource, OperatorSpec, ResolvedOperator,
    OPERATOR_API_VERSION_V1ALPHA1, OPERATOR_KIND,
};
